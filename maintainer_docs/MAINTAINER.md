...
| `nightly-compliance.yml` | Daily 04:00 UTC, dispatch | Rebuilds `main`'s image from scratch and re-runs the gate against it; a failure means something outside the repo moved |
