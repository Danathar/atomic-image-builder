...
Retrospectives on completed work, written once the outcome is known.
...
turned out to be about, which is usually not what it looked like at the start.

Each file is dated in its name and covers work that is finished. Nothing here
describes current state, so nothing here goes stale — same reason as the other
two. Start from
...
- [2026-09-03 — the ACMM sweep](2026-09-03-acmm-sweep.md)
